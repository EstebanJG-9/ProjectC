...
namespace Almacen_01
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int[] codIngresado = new int[] { 4, 5, 6 };
            string[] productoIngresado = new string[3];
            double[] precioIngresado = new double[3];

            string[] resultado = new string[productosCodigo.Length + productosNombres.Length+productosPrecios.Length
                                            +codIngresado.Length+productoIngresado.Length+precioIngresado.Length];
                    ...
                    while (salirPrograma)
                    {
                        ...
                        switch (opcionMenu)
                        {
                            ...
                            case 2:
                                ...
                                Console.Write("PRODUCTOS  ANTERIORMENTE INGRESADOS  " + "\n\n\n ");
